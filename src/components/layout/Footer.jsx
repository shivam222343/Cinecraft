      ...
      <div className="container-custom py-16">
            ...
            <div className="flex items-center space-x-2">
              <div className="w-10 h-10 bg-gradient-to-br from-primary-600 to-primary-400 rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-xl">
                  <img className="rounded-md" src="./2.png" alt="" />
                </span>
              </div>
              <span className="text-xl font-bold">CineCraft Media</span>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed">
              Crafting stories, creating impact. From cameras to drones, from concept to broadcast. 
              We craft visuals that move people.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">hello@cinecraft.media</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} CineCraft Media. All rights reserved.
          </p>
